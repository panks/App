...
import com.app.reminderapp.R.raw;
	...
	*/
    ...
    private Notification createReminderNotification(Cursor reminderCursor){
    	...
    	CharSequence tickerText = title;  
    		//getResources().getString(R.string.new_reminder); //ticket-text
    	...
    	contentView.setImageViewResource(R.id.notify_image, R.drawable.androidmarker);
    	contentView.setTextViewText(R.id.notify_text, body);
    ...
    private Notification setupRing(Notification notification){
    	notification.sound = Uri.parse("android.resource://com.app.placeme/" + R.raw.beep_jazz);
    ...
    private boolean checkTriggerConditions(Location myLoc, Cursor reminderCursor){
    	...
    	if(mLastLoc == null){ 
    		mLastLoc = myLoc;
    		/* DEBUG JFK coordinates
    		mLastLoc = new Location(LocationManager.GPS_PROVIDER);

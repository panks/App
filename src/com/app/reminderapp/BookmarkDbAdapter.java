...
public class BookmarkDbAdapter {
     ...
     */
    public long createLocation(Bookmark bookmark) {
     ...
     */
    public boolean updateLocation(long rowId, Bookmark b){
    ...
    public Cursor fetchLocations(String[] select_cols, String match_cond) throws SQLException {
     ...
     * @return true if the note was successfully updated, false otherwise
     */
    public boolean updateReminder(long rowId, Bookmark bookmark) {
        ContentValues args = new ContentValues();
        args.put(KEY_NAME, bookmark.getName());
        args.put(KEY_LAT, bookmark.getLat());
        args.put(KEY_LON, bookmark.getLon());
        args.put(KEY_ADDR, bookmark.getAddress());

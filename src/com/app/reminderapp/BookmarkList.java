...
import com.app.reminderapp.R.drawable;
import com.app.reminderapp.R.id;
import com.app.reminderapp.R.layout;
import com.app.reminderapp.R.menu;
import com.app.reminderapp.R.string;
...
public class BookmarkList extends ListActivity {
    ...
    private void fillData() {
        ...
        Cursor bookmarkCursor = bmarkDbHelper.fetchAllLocations();
    ...
    private void deleteBookmark(long id){
        bmarkDbHelper.deleteLocation(id);
        fillData();
    }
    ...
    private void saveSelection(Bundle extras, long id){
    	...
    	Cursor bcursor = bmarkDbHelper.fetchLocation(id);
    ...
    private Dialog createDirectionsDialog(Bookmark selectedBookmark){
        ...
        //set up buttons
        Button toHereFromMyLoc = (Button) directionsDialog.findViewById(R.id.to_here);
        toHereFromMyLoc.setText("To " + selectedBookmark.getName().toUpperCase() + " from here");
        // store objects to be passed in within the view so it can be used to access
        toHereFromMyLoc.setTag(R.layout.directions_dialog2, directionsDialog);
        
        toHereFromMyLoc.setTag(R.id.to_here, selectedBookmark);
        ...
        Button fromHereToMyLoc = (Button) directionsDialog.findViewById(R.id.from_here);
        fromHereToMyLoc.setText("From "+ selectedBookmark.getName().toUpperCase() + " to here");
        fromHereToMyLoc.setTag(R.layout.directions_dialog2, directionsDialog);
        
        fromHereToMyLoc.setTag(R.id.from_here, selectedBookmark);
        fromHereToMyLoc.setOnClickListener(new OnClickListener() {        	        	
        	@Override
            public void onClick(View v) {
	        	//launch browser
	            Dialog directionsDialog = (Dialog) v.getTag(R.layout.directions_dialog2);
